<template>
    <div class="container relative z-50 px-4 mx-auto -mt-16 2xl:-mt-28">
        <div id="generator" class="p-6 bg-stone-100 shadow-md lg:p-12 scroll-mt-6 rounded shadow-neutral-800/90">
            ...
            <div class="mt-10">
                <div class="relative mt-12 lg:flex">
                    <div class="w-full lg:w-1/2 xl:w-2/5">
                        <h3 class="text-xl font-semibold text-gray-700 ">Choose Colors</h3>

                        <p class="max-w-md mt-2 text-gray-700 ">Pick colors from the Tailwind CSS Palette that fit your design.</p>
                    </div>

                    <div class="w-full mt-4 lg:w-1/2 lg:pl-10 xl:pl-16 xl:w-3/5 lg:mt-0" v-show="active == 'text'">
                        <div>
                            <label class="font-medium text-gray-700">Your Text</label>
                            
                            <input v-model="text" class="w-full h-12 px-4 mt-2 font-medium text-gray-700 bg-white border border-gray-200 rounded focus:border-indigo-500 focus:outline-none focus:ring focus:ring-indigo-600 focus:ring-opacity-20" />
                        </div>
                    </div>
                </div>
                ...
                <div class="relative mt-6 lg:flex">
                    <div class="transition-all duration-500 " :class="fullWidth ? 'w-full ease-in' : ' lg:w-1/2 xl:w-2/5 ease-out'">
                        ...
                        <div v-show="active == 'text'" class="w-full flex items-center p-6 bg-gray-50 rounded-xl h-72 md:h-96 xl:h-[28rem]">
                            <h2 v-text="text" class="mx-auto [font-size:var(--step-3)] font-bold break-words  truncate" :class="classes()"> </h2>
                        </div>

                        <button @click="randomGradient" class="flex items-center mx-auto mt-4 space-x-3 font-semibold grey-600 transition-colors duration-300 hover:text-sky-500 focus:outline-none bg-gray-900 hover:bg-gray-700 text-white  px-4 py-2.5 rounded-md">
                ...
                <div class="relative mt-12 lg:flex lg:space-x-10 xl:space-x-16">
                    ...
                    <div class="w-full mt-4 lg:w-1/2 xl:w-3/5 lg:mt-0">
                        <div class="md:flex md:items-center md:space-x-4">
                            <div class="md:w-1/2">
                                <label class="font-medium text-gray-600">Via</label>
                                
                                <custom-select 
                                    :options="[
                                        { title: 'ON', value: false },
                                        { title: 'OFF', value: true },
                                    ]"
                                    :default="viaActive"
                             ...
                             <div class="mt-4 md:w-1/2 md:mt-0">
                                <label class="font-medium text-gray-600">Direction</label>
