            ...
            <div class="mt-10">
                <div class="relative mt-12 lg:flex">
                    <div class="w-full lg:w-1/2 xl:w-2/5">
                        <h3 class="text-xl font-semibold text-white ">Choose Colors</h3>

                        <p class="max-w-md mt-2 text-white ">Pick colors from the Tailwind CSS Palette that fit your design.</p>
                    </div>

                    <div class="w-full mt-4 lg:w-1/2 lg:pl-10 xl:pl-16 xl:w-3/5 lg:mt-0" v-show="active == 'text'">
                        <div>
                            <label class="font-medium text-white">Your Text</label>
                ...
                <div class="relative mt-6 lg:flex">
                    <div class="transition-all duration-500 " :class="fullWidth ? 'w-full ease-in' : ' lg:w-1/2 xl:w-2/5 ease-out'">
                        ...
                        <button @click="randomGradient" class="flex items-center mx-auto mt-4 space-x-3 font-semibold text-white transition-colors duration-300 hover:text-indigo-500 focus:outline-none">
                ...
                <div class="relative mt-12 lg:flex lg:space-x-10 xl:space-x-16">
                    ...
                    <div class="w-full mt-4 lg:w-1/2 xl:w-3/5 lg:mt-0">
                        <div class="md:flex md:items-center md:space-x-4">
                            <div class="md:w-1/2">
                                <label class="font-medium text-white">Via</label>
                             ...
                             <div class="mt-4 md:w-1/2 md:mt-0">
                                <label class="font-medium text-white">Direction</label>
