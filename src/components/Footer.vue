<template>
    <div class="bg-neutral-900">
        <div class="container flex flex-col items-center px-4 py-6 mx-auto space-y-6 lg:space-y-0 lg:flex-row lg:justify-between">
            ...
            <p class="text-sm text-center text-gray-500">&copy; {{ new Date().getFullYear() }}  designed by <a target="_blank" href="https://asadbek.dev" class="hover:text-primary">Asadbek</a>, all rights reserved.</p>

            <div class="flex items-center space-x-6">
                <a href="https://twitter.com/realAsadbek" target="_blink" class="text-gray-500 transition-colors duration-300 hover:text-primary">
